 ...
 * @version V 0.2.1
 * @date 29.05 <p></<p>
 * This class is subclass from {@link Player} <p></<p>
 * {@link HumanPlayer} can {@link #blockSpace(Board)} and {@link #makeMove(Board)}<p></<p>
...
public class HumanPlayer extends Player {
  ...
  */
	...
	/**
	 * HumanPlayer block field  {@link #myMove}
	 *  If input is {@link board#isValidMove(myMove) not valid} he has to give a other input.
	 */
	@Override
	...
	/**
	 * HumanPlayer set his  figure at {@link #myMove} after it was read with {@link Game#readInput()  }. If input is {@link board#isValidMove(myMove) not valid} he has to give a other input.
	 */
	@Override
